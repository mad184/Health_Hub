...
public class APIManager {
    ...
    private JSONObject getJsonFromAPI(String searchString) throws UnirestException {
        ...
        HttpResponse<String> response = Unirest.get("https://nutritionix-api.p.rapidapi.com/v1_1/search/" + search + params)
    ...
    /**
     * Used to convert the JSONArray of hits returned by the api into a ArrayList of food items of the top three
     * hits

...
public interface InstructorInterface extends StaffInterface{
  ...
  /**
   * Adds a Client to the Instructor's Client list. Client must be registered
   * in the system.
  ...
  /**
   * Removes a Client from the Instructor's Client list. Client must be
   * registered in the Instructor's list beforehand.
   ...
   * Client must be in the Instructor's Client list.
  ...
  /**
   * Removes a comment on the Client's profile.
   * Client must be in the Instructor's client list.
  ...
  /**
   * Gets all information about a Client. Client must be in
   * the Instructor's Client list.

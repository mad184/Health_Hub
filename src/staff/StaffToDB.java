...
public class StaffToDB {
     ...
     */
    public void updateInstructor(int instructorID, JSONObject instructorJSON) throws JsonObjectException, EmptyQueryException {
     ...
     * @throws EmptyQueryException When query returns nothing
     */
    public void updateManager(int managerID, JSONObject managerJSON) throws JsonObjectException, EmptyQueryException {
